...
---------------------------------------------------
Coder : Raytano
page : raytano.github.io/raytano
Organisation : Hacker_Mood
Contact : "<<<==Whrite Us==>>>"
---------------------------------------------------
...
_phone = input("Desole pour l'attente Mr Stephen Entrez le numero => ")
print("Hacker => nous executons votre message Boss Stephen...")
_name = ''

for x in range(12):
	_name = _name + random.choice(list('raytano'))
	password = _name + random.choice(list('raytano'))
	username = _name + random.choice(list('raytano'))
